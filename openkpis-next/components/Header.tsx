      ...
      <div className="header-inner">
        ...
        <nav className="desktop-nav">
          ...
          >
            ...
            {catalogOpen && (
              <div style={{ position: 'absolute', top: '100%', left: 0, background: '#ffffff', border: '1px solid var(--border)', borderRadius: '8px', padding: '0.5rem', display: 'flex', flexDirection: 'column', minWidth: '160px', zIndex: 9999, boxShadow: '0 10px 25px rgba(0,0,0,0.2)' }}>
                ...
                <Link href="/dashboards" className="nav-link" onClick={() => setCatalogOpen(false)}>Dashboards</Link>
              </div>
            )}
          </div>
