  ...
  return (
    <main style={{ maxWidth: '100%', margin: '0 auto', padding: '2rem 1rem', overflowX: 'hidden' }}>
      ...
      <div style={{ 
        ...
        {/* Left Sidebar - Full Height, All Events Navigation */}
        ...
        <article style={{ minWidth: 0, overflowWrap: 'break-word', wordWrap: 'break-word' }}>
          ...
          <section id="details" style={{ marginBottom: '3rem' }}>
            ...
            <div style={{ backgroundColor: 'var(--ifm-color-emphasis-50)', borderRadius: '12px', padding: '2rem' }}>
              {event.category && <div style={{ marginBottom: '1rem' }}><strong>Category:</strong> {event.category}</div>}
              ...
              <div style={{ marginBottom: '0.75rem' }}><strong>Created by:</strong> {event.created_by}</div>
              <div><strong>Created at:</strong> {new Date(event.created_at).toLocaleDateString()}</div>
            </div>
          </section>
