...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  return generateEntityMetadata(dimension, {
    type: 'dimension',
    typeLabel: 'Dimension',
...
export default async function DimensionDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const structuredData = generateEntityStructuredData(dimension, {
    type: 'dimension',
    typeLabel: 'Dimension',
    typeLabelPlural: 'Dimensions',
    path: '/dimensions',
          ...
          <div className="detail-header">
            ...
            <div className="detail-header-row">
              ...
              <div className="detail-header-actions">
                <AddToPlanButton item={{ id: dimension.id, type: 'dimension', name: dimension.name }} variant="icon" />
                <AddToAnalysisButton itemType="dimension" itemId={dimension.id} itemSlug={dimension.slug} itemName={dimension.name} variant="icon" />
